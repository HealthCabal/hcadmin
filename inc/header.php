...
<head>
  ...
  <link rel="stylesheet" href="ui/vendors/css/vendor.bundle.addons.css">
  <!-- endinject -->
  <!-- plugin css for this page -->
  <!-- End plugin css for this page -->
  <!-- inject:css -->
  <link rel="stylesheet" href="ui/css/vertical-layout-light/style.css">
  <script src="https://cdn.tiny.cloud/1/r0ije2d1lytmqtmnkwqmgosysgojhyb5cztk4u4585eou1hc/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo" href="#" width="10"><img src="ui/logo.png" alt="logo" /></a>
        <a class="navbar-brand brand-logo-mini" href="index.html"><img src="ui/logosmall.png" alt="logo" /></a>
      </div>
